!function (u) {
    console.log(1)
    var a = {treshold: 4, maximumItems: 5, highlightTyped: !0, highlightClass: "text-primary"};
    ...
    function l(e, t) {
        ...
        for (var l = 0, n = Object.keys(t.source), r = 0; r < n.length; r++) {
            var d = n[r], i = t.source[d], s = {label: t.label ? i[t.label] : d, value: t.value ? i[t.value] : i};
