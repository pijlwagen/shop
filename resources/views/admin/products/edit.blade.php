                        ...
                        <div class="card-body">
                            <div class="tab-content">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-lg-7 mb-3">
                                            ...
                                            <input type="text" name="name" id="name" placeholder="My Product"
                                                   ...
                                                   value="{{ old('name', $product->name) }}" v-model="name">
                                            @error('name')
                                ...
                                <div class="tab-pane fade" id="seo" role="tabpanel" aria-labelledby="seo-tab">
                                    <div class="form-group row">
                                        <div class="col-lg-12">
                                            ...
                                            <textarea type="text" name="seo-description" id="seo-description"
                                                      ...
                                                      v-model="seo.description">{{ old('seo-description', $product->seo->description ?? '') }}</textarea>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-lg-7">
                                            ...
                                            <input type="text" name="seo-title" id="seo-title"
                                                   ...
                                                   value="{{ old('seo-title', $product->seo->title ?? '') }}"
                                                   v-model="seo.title">
                                            @error('seo-title')
                                            <div class="invalid-feedback" role="alert">
                                                {{ $message }}
                                        ...
                                        <div class="col-lg-5">
                                            ...
                                            <input type="text" name="seo-keywords" id="seo-keywords"
                                                   ...
                                                   value="{{ old('seo-keywords', $product->seo->keywords ?? '') }}">
                                            @error('seo-keywords')
                                            <div class="invalid-feedback" role="alert">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="form-group">
                                        <div class="custom-control custom-checkbox mr-sm-2 mt-auto">
                                            <input type="checkbox" class="custom-control-input"
                                                   id="delete-seo-image">
                                            <label class="custom-control-label" for="delete-seo-image">Remove
                                                current image</label>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            @foreach($product->images as $image)
                                                <div class="col-sm-3">
                                                    <input type="checkbox" name="delete[{{ $image->id }}]"
                                                           id="delete-image-{{ $image->id }}" hidden
                                                           class="image-checkbox">
                                                    <label for="delete-image-{{ $image->id }}"><img
