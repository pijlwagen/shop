                                    ...
                                    <div class="form-group">
                                        <div class="custom-control custom-checkbox mr-sm-2">
                                            <input type="checkbox" class="custom-control-input" name="hide"
                                                   id="hide" {{ $category->hidden ? 'checked' : '' }}>
    ...
    <script>
        var app = new Vue({
            ...
            created: function () {
                ...
                this.description = '{{ old('description', $category->description) }}';
                this.seo.title = '{{ old('seo-title', $category->seo->title) }}';
                this.seo.description = '{{ old('seo-description', $category->seo->description) }}';
                this.seo.keywords = '{{ old('seo-description', $category->seo->keywords) }}';
            }
        })
    </script>
@endpush
