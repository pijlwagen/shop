                                        ...
                                        @if ($product->images->first())
                                            @if ($product->discounts->first())
                                                <span class="badge badge-danger"
                                                      style="font-size: 1rem; margin-top: 10px; margin-left: 10px; position: absolute">ON SALE</span>
                                            @endif
                                    ...
                                    <div class="card-body text-center">
                                        ...
                                        @if ($product->discounts->first())
                                            <span class="item-price" style="font-size: 1rem"><span
                                                    class="discount-price text-danger">&euro;{{ number_format(Helper::discountedPrice($product, false), 2, ',', '.') }}</span> <s
                                                    class="text-muted">&euro;{{ number_format($product->price, 2, ',', '.') }}</s></span>
                                        @else
